...
<div class="main-header">
    ...
    <p>Tác giả: Lù Văn Lâm - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0333 878 999</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lù Văn Lâm - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0333 878 999</div>", unsafe_allow_html=True)
